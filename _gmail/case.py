...
RELAY_GMAIL = [
    LayCfg(
        ...
        description="Bot Failed Notification"
    ),
    LayCfg(
        case=Case(
        ...
        description="Dev Email Actor Failed"
    ),
    LayCfg(
        case=Case(
        ...
        description="Crawl Failed Notification"
    ),
     LayCfg(
        case=Case(
        ...
        description="Deployment Failed Notification"
    ),
    LayCfg(
        case=Case(
        ...
        description="Deployment Successful Notification"
    ),
    LayCfg(
        case=Case(
            case_id="WELCOME_EMAIL",
            action=lambda user_email, user_name: processor.gmail_send_message(
                user_email,
                processor.get_welcome_content(user_name),
        ...
        description="Welcome to NeuralVerse Email"
    )
]
