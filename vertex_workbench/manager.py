...
class VertexWorkbenchManager:
    """
    Deploy custom container images from registry to Vertex AI Workbench
    and execute code there. All params are explicit for transparency.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            location: Zone (e.g. us-central1-b). Default: GCP_ZONE or GCP_REGION env.
            credentials: Optional; used only if we add API-based methods later.
        """
        self.project_id = project_id or os.environ.get("GCP_PROJECT_ID", "")
        self.location = location or os.environ.get("GCP_ZONE") or os.environ.get("GCP_REGION", "us-central1-b")
...
if __name__ == "__main__":
    ...
    mgr = VertexWorkbenchManager(project_id=project, location=location)
    registry = ArtifactAdmin()

    url = mgr.deploy(
        instance_name="qfs-workbench-01",
        container_repository=registry.get_latest_image(),
