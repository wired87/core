...
if __name__ == '__main__':
    ...
    BIGQUERY_DATASET_ID = "brainmaster"
    ...
    sql_query_func = FunctionDeclaration(
        name="sql_query",
        description="Get information from admin_data in BigQuery using SQL queries",
        parameters={
            "type": "object",
            "properties": {
                "query": {
                    ...
                    try:
                        ...
                        if response.function_call.name == "sql_query":
                            ...
                            try:
                                ...
                                the admin_data. Try rephrasing your question to help the
