"""
Grid package entry point: python -m grid [--cfg PATH] [--cfg-string JSON]
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Grid workflow: run with cfg from file or string"
    )
    parser.add_argument(
        "--cfg",
        type=str,
...
def _load_cfg(args: argparse.Namespace) -> dict:
    """Load cfg from --cfg-string or --cfg file."""
