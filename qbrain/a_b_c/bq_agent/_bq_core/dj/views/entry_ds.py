...
class ProcessDSView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        """
        Extract URLs, filter CSV files, and insert valid admin_data into BigQuery.
        """
    ...
    def process_csv_to_bigquery(self, url):
        """
        Fetch CSV from the URL, process it, and insert admin_data into BigQuery.
        """
        try:
            ...
            # Insert admin_data into BigQuery
            client = BQ
