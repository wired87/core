...
def inspect_code_structure(code_content: str, user_id: str, g_utils_instance: GUtils) -> Dict[str, Any]:
    """
    Parses code content, runs the inspector, and returns the graph data.
    ...
    try:
        ...
        inspector = StructInspector(user_id, g_utils_instance)
...
# from utils.graph.local_graph_utils import GUtils
#
# code = "class MyClass:\n    x: int = 5\n    def run(self, data: list[int]) -> bool: return True"
# graph_util = GUtils("my_user")
