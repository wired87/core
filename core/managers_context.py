...
def get_env_manager():
    ...
    from core.env_manager.env_lib import _default_env_manager
...
def get_session_manager():
    ...
    from core.session_manager.session import _default_session_manager
...
def get_injection_manager():
    ...
    from core.injection_manager.injection import _default_injection_manager
...
def get_file_manager():
    ...
    from core.file_manager.file_lib import _default_file_manager
...
def get_model_manager():
    ...
    from core.model_manager.model_lib import _default_model_manager
...
def get_param_manager():
    ...
    from core.param_manager.params_lib import _default_param_manager
...
def get_module_manager():
    ...
    from core.module_manager.ws_modules_manager.modules_lib import _default_module_manager
...
def get_field_manager():
    ...
    from core.fields_manager.fields_lib import _default_field_manager
...
def get_method_manager():
    ...
    from core.method_manager.method_lib import _default_method_manager
...
def get_user_manager():
    ...
    from core.user_manager.user import _default_user_manager
