...
class SessionManager(BQCore):
    ...
    def __init__(self):
        ...
        #print(f"SessionManager initialized with dataset: {self.DATASET_ID}")
    ...
    def _ensure_sessions_table(self) -> bool:
        ...
        """
        try:
            print("Checking/creating sessions table...")
    ...
    def _ensure_link_tables(self):
        ...
        try:
            # sessions_to_envs
            # Explicitly pass dict schema as required by BQCore.get_table_schema
            ...
            print(f"Error ensuring link tables: {e}")
    ...
    def create_session(self, user_id: str) -> Optional[int]:
        ...
        try:
            ...
            # Check if session_id already exists (extremely unlikely but safety check)
            ...
            print(f"Creating new session: {session_data}")
            self.qb.set_item("sessions", session_data, keys={"id": session_id})
    ...
    def get_session_envs(self, user_id: str, session_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"Error retrieving user environments: {e}")
            return {"envs": []}
    ...
    def rm_link_env_session(self, user_id: str, session_id: str, env_id: str):
        ...
        try:
            ...
            print(f"Error removing link env session: {e}") 
    ...
    def get_or_create_active_session(self, user_id: str) -> Optional[int]:
        ...
        if session_id:
            print(f"Found active session {session_id} for user {user_id}")
