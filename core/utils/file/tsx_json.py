...
class GNNTester:
    ...
    def find_similar_components(self, component_name, top_n=5):
        ...
        component_vector = jnp.array(self.embeddings[component_name]).reshape(1, -1)
        all_vectors = jnp.array(list(self.embeddings.values()))
    ...
    def visualize_embeddings(self):
        ...
        vectors = jnp.array(list(self.embeddings.values()))
        labels = jnp.array(self.node_names)
